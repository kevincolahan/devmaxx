...
- **All Anthropic API calls use model:** `claude-sonnet-4-5-20241022`
...
### AI / Agents
- **Primary model:** Anthropic claude-sonnet-4-5-20241022
- **Max tokens:** 2048
...
Anthropic claude-sonnet-4-5-20241022, Resend, Cloudflare R2, Stripe.
All agents extend BaseAgent from packages/agent-core/src/base-agent.ts.
